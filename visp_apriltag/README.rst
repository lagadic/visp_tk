...
It permits to detect AprilTag and ArUco tags in an image. The node will publish a ``/<node_name>/tags_info``
...
- **REQUIRED** ``tag_family``: the tag family the node will have to detect. See `ViSP documentation <https://visp-doc.inria.fr/doxygen/visp-daily/classvpDetectorAprilTag.html>`__ for more information.
...
- **REQUIRED** ``tag_size``: the dimension of the tag, in meters. See `ViSP documentation <https://visp-doc.inria.fr/doxygen/visp-daily/classvpDetectorAprilTag.html>`__ for more information.
- **REQUIRED** ``pose_method``: the method to use to compute the pose of a tag. See `ViSP documentation <https://visp-doc.inria.fr/doxygen/visp-daily/classvpDetectorAprilTag.html>`__ for more information.
